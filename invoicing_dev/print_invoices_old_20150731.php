<h1>We are trying out the new invoices. For now, go <a href='http://poster-server/invoicing/print_invoices_20150702.php'>here</a> to print invoices.</h1>

Changes:
<ul>
	<li><b>Customer's #packing notes shown on invoice</b></li>
	<li>Notes at top instead of bottom</li>
	<li>"Office Copy" watermark</li>
	<li>Total count of items shown</li>
	<li>"package invoice" has P&H items combined</li>
